...
function isBudgetEnough(data) {
    ...
    data.shops.forEach(item => {
        areaMall += item.width * item.length;
    })
    let volumeMall = areaMall * data.height;
    
    let budgetMall = Math.floor(data.budget / data.moneyPer1m3);

    console.log(areaMall);
    console.log(volumeMall);
    console.log(budgetMall);  

    if(volumeMall > budgetMall) {
